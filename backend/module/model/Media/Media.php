...
class Media extends Connection{
    ...
    public function saveMedia(){
        $sql="INSERT INTO {$this->table} VALUES('','{$this->nom_media}','{$this->desc_media}','{$this->source_media}','{$this->id_type_media}','{$this->slider_media}','{$this->id_play_list_media}')";
    ...
    public function updateMedia($id,$nom,$source,$desc,$id_type,$slider,$id_play_list_media)
    {
        $sql = "UPDATE {$this->table} SET
                  ...
                  ,{$this->id_play_list_mediaCol}='$id_play_list_media'
